...
const secondaryBtn =
  'inline-block border-2 border-amber-400 font-medium uppercase text-stone-900 outline-offset-8 transition-all duration-300 focus-visible:outline-none focus-visible:ring focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-amber-50';

const btnStyles: { [K in BtnStylesType]: string } = {
  primary: primaryBtn + ' rounded-xl px-3 py-2 md:px-4 md:py-3 md:text-lg',
  secondary:
    secondaryBtn + ' rounded-xl px-3 py-1.5 md:px-4 md:py-2.5 md:text-lg hover:bg-amber-300 active:bg-amber-100',
  ...
  round:
    'rounded-full px-2.5 py-0.5 md:px-3.5 md:py-1 text-lg hover:bg-orange-400 active:bg-orange-500 ' + secondaryBtn,
};
